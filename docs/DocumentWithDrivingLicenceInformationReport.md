...
**properties** | [**DocumentPropertiesWithDrivingLicenceInformation**](DocumentPropertiesWithDrivingLicenceInformation.md) |  | [optional] [default to undefined]

## Example

```typescript
import { DocumentWithDrivingLicenceInformationReport } from '@onfido/api';

const instance: DocumentWithDrivingLicenceInformationReport = {
    id,
    created_at,
    href,
    status,
