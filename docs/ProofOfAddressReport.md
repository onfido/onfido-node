...
**breakdown** | [**ProofOfAddressBreakdown**](ProofOfAddressBreakdown.md) |  | [optional] [default to undefined]
**properties** | [**ProofOfAddressProperties**](ProofOfAddressProperties.md) |  | [optional] [default to undefined]

## Example

```typescript
import { ProofOfAddressReport } from '@onfido/api';

const instance: ProofOfAddressReport = {
    id,
    created_at,
    href,
    status,
