...
**breakdown** | [**FacialSimilarityMotionBreakdown**](FacialSimilarityMotionBreakdown.md) |  | [optional] [default to undefined]
**properties** | [**FacialSimilarityMotionProperties**](FacialSimilarityMotionProperties.md) |  | [optional] [default to undefined]

## Example

```typescript
import { FacialSimilarityMotionReport } from '@onfido/api';

const instance: FacialSimilarityMotionReport = {
    id,
    created_at,
    href,
    status,
