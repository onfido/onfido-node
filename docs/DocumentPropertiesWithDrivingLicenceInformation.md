...
**driving_licence_information** | [**Array&lt;DocumentPropertiesDrivingLicenceInformationItem&gt;**](DocumentPropertiesDrivingLicenceInformationItem.md) |  | [optional] [default to undefined]

## Example

```typescript
import { DocumentPropertiesWithDrivingLicenceInformation } from '@onfido/api';

const instance: DocumentPropertiesWithDrivingLicenceInformation = {
    date_of_birth,
    date_of_expiry,
    personal_number,
    document_numbers,
