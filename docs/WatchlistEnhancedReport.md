...
**breakdown** | [**WatchlistEnhancedBreakdown**](WatchlistEnhancedBreakdown.md) |  | [optional] [default to undefined]
**properties** | [**WatchlistEnhancedProperties**](WatchlistEnhancedProperties.md) |  | [optional] [default to undefined]

## Example

```typescript
import { WatchlistEnhancedReport } from '@onfido/api';

const instance: WatchlistEnhancedReport = {
    id,
    created_at,
    href,
    status,
