...
**breakdown** | [**DeviceIntelligenceBreakdown**](DeviceIntelligenceBreakdown.md) |  | [optional] [default to undefined]
**properties** | [**DeviceIntelligenceProperties**](DeviceIntelligenceProperties.md) |  | [optional] [default to undefined]

## Example

```typescript
import { DeviceIntelligenceReport } from '@onfido/api';

const instance: DeviceIntelligenceReport = {
    id,
    created_at,
    href,
    status,
