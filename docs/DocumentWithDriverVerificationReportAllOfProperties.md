...
**drivers_licence** | **boolean** | True for **non-restricted** driving licences | [optional] [default to undefined]
**restricted_licence** | **boolean** | True for **limited/restricted** driving license, including learner\&#39;s permits | [optional] [default to undefined]
**raw_licence_category** | **string** | Underlying, non-normalised, licence category (e.g. \&quot;Junior operators license\&quot;) | [optional] [default to undefined]
**raw_vehicle_classes** | **string** | Comma-separated vehicle classes that the user is qualified for | [optional] [default to undefined]
**manual_transmission_restriction** | **boolean** | True if the user is not qualified to drive a manual transmission | [optional] [default to undefined]
**vehicle_class_details** | [**Array&lt;DocumentWithDriverVerificationReportAllOfPropertiesAllOfVehicleClassDetailsInner&gt;**](DocumentWithDriverVerificationReportAllOfPropertiesAllOfVehicleClassDetailsInner.md) | Detailed classes/categories information | [optional] [default to undefined]
**passenger_vehicle** | [**DocumentWithDriverVerificationReportAllOfPropertiesAllOfPassengerVehicle**](DocumentWithDriverVerificationReportAllOfPropertiesAllOfPassengerVehicle.md) |  | [optional] [default to undefined]

## Example

```typescript
import { DocumentWithDriverVerificationReportAllOfProperties } from '@onfido/api';

const instance: DocumentWithDriverVerificationReportAllOfProperties = {
    date_of_birth,
    date_of_expiry,
    personal_number,
    document_numbers,
