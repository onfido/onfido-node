...
**breakdown** | [**WatchlistStandardBreakdown**](WatchlistStandardBreakdown.md) |  | [optional] [default to undefined]
**properties** | [**WatchlistStandardProperties**](WatchlistStandardProperties.md) |  | [optional] [default to undefined]

## Example

```typescript
import { WatchlistSanctionsOnlyReport } from '@onfido/api';

const instance: WatchlistSanctionsOnlyReport = {
    id,
    created_at,
    href,
    status,
