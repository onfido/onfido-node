...
```typescript
import { DocumentBreakdownVisualAuthenticityBreakdownFaceDetection } from '@onfido/api';

const instance: DocumentBreakdownVisualAuthenticityBreakdownFaceDetection = {
    result,
    properties,
};
```
