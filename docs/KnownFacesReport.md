...
**breakdown** | [**KnownFacesBreakdown**](KnownFacesBreakdown.md) |  | [optional] [default to undefined]
**properties** | [**KnownFacesProperties**](KnownFacesProperties.md) |  | [optional] [default to undefined]

## Example

```typescript
import { KnownFacesReport } from '@onfido/api';

const instance: KnownFacesReport = {
    id,
    created_at,
    href,
    status,
