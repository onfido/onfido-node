...
**breakdown** | [**FacialSimilarityVideoBreakdown**](FacialSimilarityVideoBreakdown.md) |  | [optional] [default to undefined]
**properties** | [**FacialSimilarityVideoProperties**](FacialSimilarityVideoProperties.md) |  | [optional] [default to undefined]

## Example

```typescript
import { FacialSimilarityVideoReport } from '@onfido/api';

const instance: FacialSimilarityVideoReport = {
    id,
    created_at,
    href,
    status,
