...
**breakdown** | [**WatchlistAmlBreakdown**](WatchlistAmlBreakdown.md) |  | [optional] [default to undefined]
**properties** | [**WatchlistAmlProperties**](WatchlistAmlProperties.md) |  | [optional] [default to undefined]

## Example

```typescript
import { WatchlistAmlReport } from '@onfido/api';

const instance: WatchlistAmlReport = {
    id,
    created_at,
    href,
    status,
