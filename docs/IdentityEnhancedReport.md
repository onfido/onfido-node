...
**breakdown** | [**IdentityEnhancedBreakdown**](IdentityEnhancedBreakdown.md) |  | [optional] [default to undefined]
**properties** | [**IdentityEnhancedProperties**](IdentityEnhancedProperties.md) |  | [optional] [default to undefined]

## Example

```typescript
import { IdentityEnhancedReport } from '@onfido/api';

const instance: IdentityEnhancedReport = {
    id,
    created_at,
    href,
    status,
