...
**breakdown** | [**FacialSimilarityPhotoBreakdown**](FacialSimilarityPhotoBreakdown.md) |  | [optional] [default to undefined]
**properties** | [**FacialSimilarityPhotoProperties**](FacialSimilarityPhotoProperties.md) |  | [optional] [default to undefined]

## Example

```typescript
import { FacialSimilarityPhotoReport } from '@onfido/api';

const instance: FacialSimilarityPhotoReport = {
    id,
    created_at,
    href,
    status,
