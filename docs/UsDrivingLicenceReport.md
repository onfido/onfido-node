...
**breakdown** | [**UsDrivingLicenceBreakdown**](UsDrivingLicenceBreakdown.md) |  | [optional] [default to undefined]
**properties** | [**DocumentProperties**](DocumentProperties.md) |  | [optional] [default to undefined]

## Example

```typescript
import { UsDrivingLicenceReport } from '@onfido/api';

const instance: UsDrivingLicenceReport = {
    id,
    created_at,
    href,
    status,
