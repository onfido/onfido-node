...
const workflow_id =
  process.env.ONFIDO_SAMPLE_WORKFLOW_ID ||
  "e8c921eb-0495-44fe-b655-bcdcaffdafe5";
const workflowIdTimeline =
  process.env.ONFIDO_SAMPLE_WORKFLOW_ID_TIMELINE ||
  "221f9d24-cf72-4762-ac4a-01bf3ccc09dd";
...
it("creates a workflow run with custom inputs", async () => {
  const workflow_id_with_custom_inputs =
    process.env.ONFIDO_SAMPLE_WORKFLOW_ID_CUSTOM_INPUTS ||
    "45092b29-f220-479e-aa6f-a6f989baac4c";
