...
describe("workflow runs outputs", () => {
  ...
  it("allows profile data capture as output", async () => {
    const workflow_id =
      process.env.ONFIDO_SAMPLE_WORKFLOW_ID_PROFILE_DATA_CAPTURE_OUTCOME ||
      "d27e510b-27a8-44c3-a3cc-bf4c0648a4ba";
  ...
  it("allows document and facial similarity photo reports as outputs", async () => {
    const workflow_id =
      process.env.ONFIDO_SAMPLE_WORKFLOW_ID_DOC_SELFIE_OUTCOME ||
