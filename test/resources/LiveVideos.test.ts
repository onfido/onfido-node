...
const exampleLiveVideo: LiveVideo = {
  ...
  href: "https://api.onfido.com/v3/live_videos/123-abc",
  downloadHref: "https://api.onfido.com/v3/live_videos/123-abc/downlaod",
  fileName: "video.mp4",
  fileType: "mp4",
  fileSize: 500_000
};
...
const exampleLiveVideoJson = {
  ...
  href: "https://api.onfido.com/v3/live_videos/123-abc",
  download_href: "https://api.onfido.com/v3/live_videos/123-abc/downlaod",
  file_name: "video.mp4",
  file_type: "mp4",
  file_size: 500_000
};
